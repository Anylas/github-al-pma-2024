package com.example.myapp014amynotehub.ui
...
import com.example.myapp014amynotehub.data.model.Category
import com.example.myapp014amynotehub.data.model.Note
import com.example.myapp014amynotehub.data.model.NoteAdapter
import com.example.myapp014amynotehub.data.model.NoteHubDatabase
import com.example.myapp014amynotehub.data.model.NoteHubDatabaseInstance
...
class MainActivity : AppCompatActivity() {
    ...
    private fun editNote(note: Note) {
        ...
        val dialog = AlertDialog.Builder(this) //naplní se ta funkce, refresh v databázi
            .setTitle("Upravit poznámku")
            .setView(dialogView)
            .setPositiveButton("Uložit") { _, _ -> //vložení stringů
                ...
                lifecycleScope.launch {
                    ...
                    database.noteDao().update(updatedNote)  // Uloží aktualizovanou poznámku, volá se třída noteDao, zavolá se update
